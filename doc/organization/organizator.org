...
Al final del dia, lo único que tengo es el menu principal, el diálogo de about,
settings y quick game. De todas formas me parece que la primera versión solo
va a tener eso. El resto lo implementaré cuando sea capaz de hacer jugar al
tablero.
...
*** Configuración
- Idioma
- Ruta para almacenar las partidas
- Ruta para almacenar los SS.EE.
